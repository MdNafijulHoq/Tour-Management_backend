...
const booking_intreface_1 = require("../booking/booking.intreface");
...
const successPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updatedBooking = yield booking_model_1.Booking.findByIdAndUpdate(updatedPayment === null || updatedPayment === void 0 ? void 0 : updatedPayment.booking, { status: booking_intreface_1.BOOKING_STATUS.COMPLETE }, { runValidators: true, session })
            .populate("tour", "title")
        ...
        yield (0, sendEmail_1.sendEmail)({
            ...
            templateData: {
                bookingDate: new Date(invoiceData.bookingDate).toLocaleDateString(),
...
const failPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield booking_model_1.Booking.findByIdAndUpdate(updatedPayment === null || updatedPayment === void 0 ? void 0 : updatedPayment.booking, { status: booking_intreface_1.BOOKING_STATUS.FAILED }, { runValidators: true, session });
        yield session.commitTransaction(); //transaction
        session.endSession();
...
const cancelPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield booking_model_1.Booking.findByIdAndUpdate(updatedPayment === null || updatedPayment === void 0 ? void 0 : updatedPayment.booking, { status: booking_intreface_1.BOOKING_STATUS.CANCEL }, { runValidators: true, session });
        yield session.commitTransaction(); //transaction
        session.endSession();
